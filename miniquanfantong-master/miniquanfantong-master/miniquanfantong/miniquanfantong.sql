...
Source Database       : miniquanfantong

Target Server Type    : MYSQL
Target Server Version : 50553
File Encoding         : 65001

Date: 2017-09-01 09:19:45
*/
...
CREATE TABLE `lr_address` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户收货地址表';

-- ----------------------------
-- Records of lr_address
-- ----------------------------
INSERT INTO `lr_address` VALUES ('1', '潘沛源', '18814373687', '2151', '2152', '2164', '11', '广东省 广州市 增城市 11', '440183', '2', '1');
...
INSERT INTO `lr_adminuser` VALUES ('3', 'ceshi2', '普通管理员', '550e1bafe077ff0b0b67f4e32f29d751', '5', '1493262042', '1');

-- ----------------------------
-- Table structure for `lr_admin_menu`
-- ----------------------------
DROP TABLE IF EXISTS `lr_admin_menu`;
CREATE TABLE `lr_admin_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '权限菜单表',
  `name` varchar(20) DEFAULT NULL,
  `moudle` varchar(20) DEFAULT 'Ht' COMMENT '模块',
  `ctrl` varchar(20) DEFAULT NULL COMMENT '控制器',
  `action` varchar(30) DEFAULT NULL,
  `digest` varchar(255) DEFAULT NULL,
  `pid` int(11) DEFAULT '0' COMMENT '上级id，0为最上级',
  `sort` int(6) DEFAULT '0' COMMENT '排序',
  `icon` varchar(30) DEFAULT NULL COMMENT '图标名称',
  `type` enum('action','submenu','topmenu') DEFAULT NULL COMMENT '类型',
  `is_show` tinyint(1) DEFAULT '1' COMMENT '是否显示，0不显示，1显示',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_admin_menu
-- ----------------------------
INSERT INTO `lr_admin_menu` VALUES ('1', '综合设置', 'Ht', '', null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('2', '管理员管理', 'Ht', null, null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('3', '会员管理', 'Ht', null, null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('4', '地区管理', 'Ht', null, null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('5', '分类管理', 'Ht', null, null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('6', '品牌管理', 'Ht', null, null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('7', '产品管理', 'Ht', null, null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('8', '订单管理', 'Ht', null, null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('9', '优惠券管理', 'Ht', null, null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('10', '广告管理', 'Ht', null, null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('11', '财务管理', 'Ht', null, null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('12', '评分/红旗榜', 'Ht', null, null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('13', '提现管理', 'Ht', null, null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('14', '系统消息', 'Ht', null, null, null, '0', '0', null, 'topmenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('15', '前台管理', 'Ht', 'More', 'pweb_gl', null, '1', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('16', '小程序配置', 'Ht', 'More', 'setup', null, '1', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('17', '分销设置', 'Ht', 'More', 'fxset', null, '1', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('18', '角色管理', 'Ht', 'Adminuser', 'admin_role', null, '2', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('19', '权限管理', 'Ht', 'Adminuser', 'admin_permission', null, '2', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('20', '管理员管理', 'Ht', 'Adminuser', 'admin_list', null, '2', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('21', '代理商管理', 'Ht', 'Adminuser', 'admin_dl', null, '2', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('22', '普通会员', 'Ht', 'User', 'normal', null, '3', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('23', 'VIP会员', 'Ht', 'User', 'vip', null, '3', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('24', '服务商', 'Ht', 'User', 'fuwus', null, '3', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('25', '经销商', 'Ht', 'User', 'jingxiao', null, '3', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('26', '地区管理', 'Ht', 'Area', 'city', null, '4', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('27', '添加分类', 'Ht', 'Category', 'add', null, '5', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('28', '分类管理', 'Ht', 'Category', 'index', null, '5', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('29', '添加品牌', 'Ht', 'Brand', 'add', null, '6', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('30', '品牌管理', 'Ht', 'Brand', 'index', null, '6', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('31', '添加产品', 'Ht', 'Product', 'add', null, '7', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('32', '产品管理', 'Ht', 'Product', 'index', null, '7', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('33', '全部订单', 'Ht', 'Order', 'index', null, '8', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('34', '添加优惠券', 'Ht', 'Voucher', 'add', null, '9', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('35', '优惠券管理', 'Ht', 'Voucher', 'index', null, '9', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('36', '添加广告', 'Ht', 'Guanggao', 'add', null, '10', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('37', '广告管理', 'Ht', 'Guanggao', 'index', null, '10', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('38', '财务管理', 'Ht', 'Account', 'index', null, '11', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('39', '评分榜', 'Ht', 'Score', 'pingfen', null, '12', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('40', '红旗榜', 'Ht', 'Score', 'hongqi', null, '12', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('41', '待审核', 'Ht', 'Getcash', 'nofinish', null, '13', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('42', '已审核', 'Ht', 'Getcash', 'finish', null, '13', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('43', '发送消息', 'Ht', 'Message', 'send', null, '14', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('44', '历史记录', 'Ht', 'Message', 'index', null, '14', '0', null, 'submenu', '1');
INSERT INTO `lr_admin_menu` VALUES ('45', '爆款设置', 'Ht', 'Product', 'setbk', null, '7', '0', null, 'submenu', '1');

-- ----------------------------
-- Table structure for `lr_admin_module`
-- ----------------------------
DROP TABLE IF EXISTS `lr_admin_module`;
CREATE TABLE `lr_admin_module` (
  `id` int(4) NOT NULL DEFAULT '0',
  `con_name` varchar(20) DEFAULT NULL COMMENT '控制器名称',
  `action` varchar(20) DEFAULT NULL COMMENT '控制器的值',
  `digest` varchar(255) DEFAULT NULL COMMENT '描述',
  `del` tinyint(1) DEFAULT NULL COMMENT '删除状态，0正常，1删除',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_admin_module
-- ----------------------------

-- ----------------------------
-- Table structure for `lr_admin_role`
-- ----------------------------
DROP TABLE IF EXISTS `lr_admin_role`;
CREATE TABLE `lr_admin_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '角色表',
  `role_name` varchar(20) DEFAULT NULL COMMENT '角色名称',
  `role_action` text COMMENT '角色权限值',
  `digest` varchar(255) DEFAULT NULL COMMENT '角色描述',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_admin_role
-- ----------------------------
INSERT INTO `lr_admin_role` VALUES ('1', '草鸡', '1,15,16,17,2,18,19,20,21,3,22,23,24,25,4,26,5,27,28,6,29,30,7,31,32,8,33,9,34,35,10,36,37,11,38,12,39,40,13,41,42,14,43,44', '111');
INSERT INTO `lr_admin_role` VALUES ('2', '1111', '1,15,16,17,2,18,19,20,21,3,22,23,24,25,4,26,5,27,28,6,29,30,7,31,32,8,33,9,34,35,10,36,37,11,38,12,39,40,13,41,42,14,43,44', '111');
INSERT INTO `lr_admin_role` VALUES ('3', '123123', '2,18,19,20,21', '123123');
INSERT INTO `lr_admin_role` VALUES ('4', '就是的发生地方', '1,15,16,17,2,18,19,20,21,3,22,23,24,25,4,26,5,27,28,6,29,30,7,31,32,8,33,9,34,35,10,36,37,11,38,12,39,40,13,41,42,14,43,44', '111');
INSERT INTO `lr_admin_role` VALUES ('5', '1111', '1,15,16,17,2,18,19,20,21,3,22,23,24,25,4,26,5,27,28,6,29,30,7,31,32,8,33,9,34,35,10,36,37,11,38,12,39,40,13,41,42,14,43,44', '1qweqweqw');
INSERT INTO `lr_admin_role` VALUES ('6', 'xczxcczxcz', '1,15,16,17,2,18,19,20,21,3,22,23,24,25,4,26,5,27,28,6,29,30,7,31,32,8,33,9,34,35,10,36,37,11,38,12,39,40,13,41,42,14,43,44', '123123');
INSERT INTO `lr_admin_role` VALUES ('7', 'xczxcczxcz', '1,15,16,17,2,18,19,20,21,3,22,23,24,25,4,26,5,27,28,6,29,30,7,31,32,8,33,9,34,35,10,36,37,11,38,12,39,40,13,41,42,14,43,44', '123123');
INSERT INTO `lr_admin_role` VALUES ('8', 'xczxcczxcz', '1,15,16,17,2,18,19,20,21,3,22,23,24,25,4,26,5,27,28,6,29,30,7,31,32,8,33,9,34,35,10,36,37,11,38,12,39,40,13,41,42,14,43,44', '123123');
...
CREATE TABLE `lr_category` (
  ...
  `bz_4` tinyint(2) NOT NULL DEFAULT '0' COMMENT '是否禁用，0正常，1禁用',
...
INSERT INTO `lr_category` VALUES ('2', '1', '全部', '1', '1493188517', '', 'UploadFiles/category/20170426/1493188517624877.png', '0', null, '0', null);
INSERT INTO `lr_category` VALUES ('5', '2', '大牌产品', '10', '1493188735', '', 'UploadFiles/category/20170720/1500515866728987.png', '1', null, '1', null);
INSERT INTO `lr_category` VALUES ('8', '2', '特价秒杀', '9', '1500221172', '', 'UploadFiles/category/20170720/1500516102581652.png', '1', null, '1', null);
INSERT INTO `lr_category` VALUES ('9', '2', '博士杰', '99', '1500221273', '', 'UploadFiles/category/20170720/1500515363614838.png', '1', null, '0', null);
INSERT INTO `lr_category` VALUES ('10', '2', '爆款产品', '7', '1500221294', '', 'UploadFiles/category/20170720/1500516185751818.png', '1', null, '1', null);
INSERT INTO `lr_category` VALUES ('13', '2', '私人订制', '6', '1500221351', '', 'UploadFiles/category/20170720/1500516240876032.png', '1', null, '1', null);
INSERT INTO `lr_category` VALUES ('14', '2', '品质生活', '5', '1500221367', '', 'UploadFiles/category/20170720/1500516305594550.png', '1', null, '1', null);
INSERT INTO `lr_category` VALUES ('15', '2', '美容护肤', '4', '1500221381', '', 'UploadFiles/category/20170720/1500516385585398.png', '1', null, '1', null);
INSERT INTO `lr_category` VALUES ('16', '2', '古董收藏', '3', '1500221403', '', 'UploadFiles/category/20170720/1500516493227627.png', '1', null, '1', null);
INSERT INTO `lr_category` VALUES ('17', '2', '全球购', '2', '1500221416', '', 'UploadFiles/category/20170720/1500516558363489.png', '1', null, '1', null);
INSERT INTO `lr_category` VALUES ('18', '2', '特价秒杀', '1', '1500221432', '', 'UploadFiles/category/20170720/1500516629708231.png', '1', null, '1', null);
...
-- ----------------------------
-- Table structure for `lr_distribut_money_log`
-- ----------------------------
DROP TABLE IF EXISTS `lr_distribut_money_log`;
CREATE TABLE `lr_distribut_money_log` (
  `id` int(12) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户id',
  `distribut_money` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '获得的佣金',
  `digest` varchar(100) DEFAULT NULL COMMENT '说明',
  `addtime` int(11) DEFAULT NULL COMMENT '获得的时间',
...
-- ----------------------------
-- Records of lr_distribut_money_log
-- ----------------------------
INSERT INTO `lr_distribut_money_log` VALUES ('1', '2', '0.00', 'ID为2的直属用户消费元,您共获得￥0的佣金奖励', '1501035773', '0');
INSERT INTO `lr_distribut_money_log` VALUES ('2', '2', '0.00', 'ID为2的团队用户消费元,您共获得￥0的佣金奖励', '1501035773', '0');
INSERT INTO `lr_distribut_money_log` VALUES ('3', '2', '0.00', 'ID为2的直属用户消费元,您共获得￥0的佣金奖励', '1501035774', '0');
INSERT INTO `lr_distribut_money_log` VALUES ('4', '2', '0.00', 'ID为2的团队用户消费元,您共获得￥0的佣金奖励', '1501035774', '0');
INSERT INTO `lr_distribut_money_log` VALUES ('5', '2', '0.00', 'ID为2的直属用户消费元,您共获得￥0的佣金奖励', '1501035774', '0');
INSERT INTO `lr_distribut_money_log` VALUES ('6', '2', '0.00', 'ID为2的团队用户消费元,您共获得￥0的佣金奖励', '1501035774', '0');
INSERT INTO `lr_distribut_money_log` VALUES ('7', '2', '0.00', 'ID为2的直属用户消费元,您共获得￥0的佣金奖励', '1501035775', '0');
INSERT INTO `lr_distribut_money_log` VALUES ('8', '2', '0.00', 'ID为2的团队用户消费元,您共获得￥0的佣金奖励', '1501035775', '0');
...
CREATE TABLE `lr_fankui` (
  ...
  `type` enum('jianyi','fankui') DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `lr_fankui` VALUES ('1', '3', '这是个大消息', 'jianyi', '1443432154', null);
INSERT INTO `lr_fankui` VALUES ('4', '2', '过得舒服就好刚打算股份', null, '1504080727', '18814125843');

-- ----------------------------
-- Table structure for `lr_getcash_log`
-- ----------------------------
DROP TABLE IF EXISTS `lr_getcash_log`;
CREATE TABLE `lr_getcash_log` (
  `id` int(12) unsigned NOT NULL AUTO_INCREMENT COMMENT '提现记录表',
  `user_id` int(11) DEFAULT NULL COMMENT '用户ID',
  `money` decimal(8,2) DEFAULT NULL COMMENT '提现金额',
  `count` varchar(30) DEFAULT NULL COMMENT '提现账号',
  `username` varchar(10) DEFAULT NULL COMMENT '真实用户名',
  `type` varchar(10) DEFAULT 'weixin' COMMENT '平台:支付宝(alipay)or微信(weixin)or银行卡(bank)',
  `addtime` int(11) DEFAULT NULL COMMENT '发起提现时间',
  `status` smallint(2) unsigned DEFAULT '0' COMMENT '状态,0为未完成,1为完成',
  `confirm` int(11) unsigned DEFAULT NULL COMMENT '确认时间',
  `finish` smallint(2) unsigned DEFAULT '0' COMMENT '确认状态,0为未确认，1位确认',
...
-- ----------------------------
-- Records of lr_getcash_log
-- ----------------------------
INSERT INTO `lr_getcash_log` VALUES ('11', '2', '500.00', '2/Jaswen沛源', 'Jaswen沛源', 'weixin', '1501038843', '0', '1504084465', '0', null, '0');
INSERT INTO `lr_getcash_log` VALUES ('12', '2', '100.00', '2/Jaswen沛源', 'Jaswen沛源', 'weixin', '1501039106', '1', '1504083481', '0', null, '0');
INSERT INTO `lr_getcash_log` VALUES ('13', '2', '100.00', '中国银行/1551511515', null, 'bank', '1504147157', '1', '1504147954', '0', null, '0');
INSERT INTO `lr_getcash_log` VALUES ('14', '2', '50.00', '中国银行/1551511515', null, 'bank', '1504147284', '0', null, '0', null, '0');
INSERT INTO `lr_getcash_log` VALUES ('15', '2', '2.00', '中国银行/1551511515', '李XX', 'bank', '1504148045', '1', '1504148074', '0', null, '0');
INSERT INTO `lr_getcash_log` VALUES ('16', '2', '0.20', '中国银行/1551511515', '李某某', 'bank', '1504158305', '0', null, '0', null, '0');
INSERT INTO `lr_getcash_log` VALUES ('17', '2', '1.00', '中国银行/1551511515', '李某某', 'bank', '1504158455', '0', null, '0', null, '0');
INSERT INTO `lr_getcash_log` VALUES ('18', '2', '5.02', '中国银行/1551511515', '李某某', 'bank', '1504158602', '0', null, '0', null, '0');

-- ----------------------------
-- Table structure for `lr_getcash_msg`
-- ----------------------------
DROP TABLE IF EXISTS `lr_getcash_msg`;
CREATE TABLE `lr_getcash_msg` (
  `id` int(12) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of lr_getcash_msg
-- ----------------------------
INSERT INTO `lr_getcash_msg` VALUES ('5', '16', '等待审核', '1501644719');
INSERT INTO `lr_getcash_msg` VALUES ('4', '16', '提出申请,金额为￥100', '1501644719');
INSERT INTO `lr_getcash_msg` VALUES ('6', '16', '审核通过,请注意查收打款!', '1501645384');
INSERT INTO `lr_getcash_msg` VALUES ('7', '16', '已确认收款!', '1501645519');
INSERT INTO `lr_getcash_msg` VALUES ('8', '17', '提出申请,金额为￥300', '1501645761');
INSERT INTO `lr_getcash_msg` VALUES ('9', '17', '等待审核', '1501645761');
INSERT INTO `lr_getcash_msg` VALUES ('10', '17', '本次提现已被注销!请重新发起!', '1501645831');
INSERT INTO `lr_getcash_msg` VALUES ('11', '18', '提出申请,金额为￥600', '1501646001');
INSERT INTO `lr_getcash_msg` VALUES ('12', '18', '等待审核', '1501646001');
INSERT INTO `lr_getcash_msg` VALUES ('13', '19', '提出申请,金额为￥100', '1501646092');
INSERT INTO `lr_getcash_msg` VALUES ('14', '19', '等待审核', '1501646092');
INSERT INTO `lr_getcash_msg` VALUES ('15', '20', '提出申请,金额为￥100', '1501646096');
INSERT INTO `lr_getcash_msg` VALUES ('16', '20', '等待审核', '1501646096');
INSERT INTO `lr_getcash_msg` VALUES ('17', '12', '审核通过,请注意查收!', '1504083481');
INSERT INTO `lr_getcash_msg` VALUES ('18', '11', '审核通过,请注意查收!', '1504084465');
INSERT INTO `lr_getcash_msg` VALUES ('19', '13', '提出申请,金额为￥100', '1504147157');
INSERT INTO `lr_getcash_msg` VALUES ('20', '13', '等待审核', '1504147157');
INSERT INTO `lr_getcash_msg` VALUES ('21', '14', '提出申请,金额为￥50', '1504147284');
INSERT INTO `lr_getcash_msg` VALUES ('22', '14', '等待审核', '1504147284');
INSERT INTO `lr_getcash_msg` VALUES ('23', '13', '审核通过,请注意查收!', '1504147954');
INSERT INTO `lr_getcash_msg` VALUES ('24', '15', '提出申请,金额为￥2', '1504148045');
INSERT INTO `lr_getcash_msg` VALUES ('25', '15', '等待审核', '1504148045');
INSERT INTO `lr_getcash_msg` VALUES ('26', '15', '审核通过,请注意查收!', '1504148074');
INSERT INTO `lr_getcash_msg` VALUES ('27', '16', '提出申请,金额为￥0.2', '1504158305');
INSERT INTO `lr_getcash_msg` VALUES ('28', '16', '等待审核', '1504158305');
INSERT INTO `lr_getcash_msg` VALUES ('29', '17', '提出申请,金额为￥1', '1504158455');
INSERT INTO `lr_getcash_msg` VALUES ('30', '17', '等待审核', '1504158455');
INSERT INTO `lr_getcash_msg` VALUES ('31', '18', '提出申请,金额为￥5.02', '1504158602');
INSERT INTO `lr_getcash_msg` VALUES ('32', '18', '等待审核', '1504158602');

-- ----------------------------
-- Table structure for `lr_getcash_set`
-- ----------------------------
DROP TABLE IF EXISTS `lr_getcash_set`;
CREATE TABLE `lr_getcash_set` (
  `id` smallint(1) unsigned NOT NULL AUTO_INCREMENT COMMENT '提现设置表',
  `timeset` smallint(2) DEFAULT NULL,
  `cashmax` decimal(10,2) DEFAULT NULL COMMENT '提现最大值',
  `cashmin` decimal(6,2) DEFAULT NULL COMMENT '提现门槛',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_getcash_set
-- ----------------------------
...
CREATE TABLE `lr_guanggao` (
  ...
  `position` tinyint(2) unsigned DEFAULT '1' COMMENT '广告位置 1首页顶部轮播 2中部轮播 ',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `lr_guanggao` VALUES ('2', '首页轮播', 'UploadFiles/adv/20170716/1500215209294476.png', '0', '0', '', '', '1');
INSERT INTO `lr_guanggao` VALUES ('10', '首页轮播', 'UploadFiles/adv/20170716/1500214961842540.png', '1493349922', '0', '', '', '1');

-- ----------------------------
-- Table structure for `lr_message`
-- ----------------------------
DROP TABLE IF EXISTS `lr_message`;
CREATE TABLE `lr_message` (
...
-- ----------------------------
-- Records of lr_message
-- ----------------------------
INSERT INTO `lr_message` VALUES ('7', '1', '嘻嘻嘻嘻', '1', '1', '1504149368');
INSERT INTO `lr_message` VALUES ('3', '1', 'fgh ', '1', '0', '1476235711');
INSERT INTO `lr_message` VALUES ('5', '1', '欢迎来到大健康', '1', '0', '1500719270');
INSERT INTO `lr_message` VALUES ('6', '1', '555', '1', '0', '1504142268');
INSERT INTO `lr_message` VALUES ('8', '1', '哈哈哈哈', '1', '1', '1504149504');
...
-- Records of lr_order
-- ----------------------------
INSERT INTO `lr_order` VALUES ('39', '2017083099971005', null, '0', '5', '268.00', '1504078029', '1', '30', '0.00', '50', '0', '', '', '', '0', null, null, '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('40', '2017083099100495', null, '0', '2', '268.00', '1504076364', '0', '30', '0.00', '50', '0', '', '', '', '0', null, null, '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('41', '2017083057985656', null, '0', '3', '168.00', '1504077737', '0', '20', '0.00', '50', '0', '', '', '', '0', null, null, '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('42', '2017083056534950', null, '0', '4', '68.00', '1504077928', '1', '10', '0.00', '50', '0', '', '', '', '0', null, null, '', '1', null, null, null, '0', null, '0');
INSERT INTO `lr_order` VALUES ('43', '', null, '0', '1', '268.00', '1504076350', '0', '30', '0.00', '50', '0', '', '', '', '0', null, null, '', '1', null, null, null, '0', null, '0');
...
-- ----------------------------
INSERT INTO `lr_order_product` VALUES ('1', '0', null, '41', '', '0.00', null, null, '1504077737', '1', null);
INSERT INTO `lr_order_product` VALUES ('2', '0', null, '42', '皇家会员', '268.00', null, null, '1504077928', '1', null);
...
CREATE TABLE `lr_program` (
  ...
  `kfbanner` varchar(100) DEFAULT NULL COMMENT '客服banner',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `lr_program` VALUES ('1', '全返通平台', '全返通平台', 'UploadFiles/logo/1493258832314637.jpg', 'Copyright © 2017', 'weixin', '0200202002', 'UploadFiles/logo/1500216079717270.jpg');

-- ----------------------------
-- Table structure for `lr_reg_order`
-- ----------------------------
DROP TABLE IF EXISTS `lr_reg_order`;
CREATE TABLE `lr_reg_order` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '会员注册缴费记录表',
  `order_sn` varchar(20) NOT NULL COMMENT '订单号',
  `uid` int(11) NOT NULL COMMENT '用户id',
  `price` decimal(8,2) DEFAULT NULL COMMENT '价格',
  `addtime` int(11) DEFAULT NULL,
  `trade_no` varchar(20) DEFAULT NULL COMMENT '支付单号',
  `status` tinyint(2) DEFAULT '10' COMMENT '10未支付，20已支付',
  `digest` varchar(255) DEFAULT NULL COMMENT '订单说明',
  `del` tinyint(1) DEFAULT '0' COMMENT '0正常，1删除',
  PRIMARY KEY (`id`),
...
-- ----------------------------
-- Table structure for `lr_site`
-- ----------------------------
DROP TABLE IF EXISTS `lr_site`;
CREATE TABLE `lr_site` (
  `id` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(30) DEFAULT NULL COMMENT '平台名称',
  `logo` varchar(100) DEFAULT NULL COMMENT 'logo',
  `banner` text COMMENT '横幅、banner、广告',
  `addtime` int(11) DEFAULT NULL COMMENT '添加时间',
  `del` tinyint(1) DEFAULT '0' COMMENT '删除状态0正常，1删除',
  `content` longtext COMMENT '平台介绍',
  `digest` varchar(255) DEFAULT NULL COMMENT '简介',
  `is_show` tinyint(1) DEFAULT '1' COMMENT '1默认显示，2不显示',
  `myqrcode_img` varchar(255) DEFAULT NULL COMMENT '我的二维码，放二维码链接',
  `myqrcode_url` varchar(150) DEFAULT NULL COMMENT '分享链接',
  `codetype` tinyint(1) DEFAULT '1' COMMENT '1默认是二维码，2是链接',
  `score` int(11) DEFAULT '0' COMMENT '推荐指数',
  `is_tj` tinyint(1) DEFAULT '0' COMMENT '0不推荐  1推荐',
  PRIMARY KEY (`id`),
...
-- Records of lr_site
-- ----------------------------
INSERT INTO `lr_site` VALUES ('1', '返现网', 'UploadFiles/Site/20170830/1504079251658490.jpg', null, '1502178850', '0', '&lt;p style=&quot;text-align:center&quot;&gt;&lt;img src=&quot;/quanfantong-php/Data/UploadFiles/Ueditor/image/20170809/1502242182980694.png&quot; title=&quot;1502242182980694.png&quot; alt=&quot;bg.png&quot;/&gt;&lt;/p&gt;&lt;p style=&quot;text-align:center&quot;&gt;&lt;img src=&quot;/quanfantong-php/Data/UploadFiles/Ueditor/image/20170809/1502242187564447.jpg&quot; title=&quot;1502242187564447.jpg&quot; alt=&quot;bbb.jpg&quot;/&gt;&lt;/p&gt;&lt;p style=&quot;text-align:center&quot;&gt;&lt;img src=&quot;http://img.baidu.com/hi/jx2/j_0028.gif&quot;/&gt;&lt;/p&gt;&lt;p style=&quot;text-align:center&quot;&gt;&lt;img src=&quot;http://api.map.baidu.com/staticimage?center=113.383841,23.141934&amp;zoom=18&amp;width=530&amp;height=340&amp;markers=113.271283,23.135288&quot; width=&quot;530&quot; height=&quot;340&quot;/&gt;&lt;/p&gt;&lt;p style=&quot;text-align: center;&quot;&gt;&lt;img src=&quot;/miniquanfantong/Data/UploadFiles/Ueditor/image/20170830/1504079468978628.jpg&quot; title=&quot;1504079468978628.jpg&quot; alt=&quot;微信图片_201708171133585.jpg&quot;/&gt;&lt;/p&gt;', '返现网官方网站,诚信的购物返现金平台。到淘宝网、淘宝商城(天猫)、京东、亚马逊等万家商城购物最高返现金60%,返利比例最高,提现1分钟到账,0.1元起提现!', '1', 'UploadFiles/Site/20170830/1504079251658490.jpg', 'http://baidu.com', '1', '9', '1');
...
CREATE TABLE `lr_sms_log` (
  `id` int(12) unsigned NOT NULL AUTO_INCREMENT COMMENT '短信发送记录表',
  `tel` varchar(20) DEFAULT NULL,
  `code` varchar(10) DEFAULT NULL,
  `start_time` int(11) DEFAULT NULL COMMENT '验证码生效时间',
  `end_time` int(11) DEFAULT NULL COMMENT '验证码失效时间',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `lr_sms_log` VALUES ('1', '18814373687', '690734', '1492484497', '1492485097');
INSERT INTO `lr_sms_log` VALUES ('2', '13250584183', '926171', '1504057338', '1504058238');
INSERT INTO `lr_sms_log` VALUES ('10', '18814125843', '359744', '1504065099', '1504065999');
...
CREATE TABLE `lr_suggest` (
  ...
  `phone` int(11) NOT NULL COMMENT '用户ID',
...
CREATE TABLE `lr_user` (
  ...
  `distribut_money` decimal(12,3) DEFAULT '0.000' COMMENT '累计佣金',
  `level` tinyint(2) DEFAULT '0' COMMENT '0游客身份，10vip，20砖石会员，30皇家会员',
  `dl_quyu` int(6) DEFAULT '0' COMMENT '代理区域',
  `qx` tinyint(4) DEFAULT '0' COMMENT '权限',
  `role_id` tinyint(4) DEFAULT '0' COMMENT '角色id',
  `bankname` varchar(20) DEFAULT NULL,
  `bankid` varchar(20) DEFAULT NULL,
  `disable` tinyint(1) DEFAULT '0' COMMENT '是否禁用，0为正常，1为禁用',
  `qrcode` varchar(255) DEFAULT NULL COMMENT '分享二维码',
  `weixin` varchar(30) DEFAULT NULL COMMENT '微信号',
  `sheng` int(6) DEFAULT NULL COMMENT '省',
  `city` int(6) DEFAULT NULL COMMENT '市',
  `quyu` int(6) DEFAULT NULL COMMENT '区',
...
-- Records of lr_user
-- ----------------------------
INSERT INTO `lr_user` VALUES ('1', 'admin', '超级管理员', '0b77520f93de693bdab0060746e38165', '1499184000', '0', null, null, '0', '0', '0', '', '', '0', '0', '0', null, '0.150', '20', '0', '6', '0', null, null, '0', null, null, null, null, null, null);
INSERT INTO `lr_user` VALUES ('2', 'LeeFon', '李某某', '', '1501576408', '0', 'https://wx.qlogo.cn/mmopen/vi_32/DYAIOgq83eqcxfluFyPMx5kN6yibZVEDSyNa3UG295cmOnGbApE9mg3FG1ic7b1fIrkMB1CoNrM0rZuY8cc6MFcQ/0', '18814125843', '0', '1', '0', 'oKUnw0ArntkFrveQu3MRjlvL3e_w', 'wx', '0', '0', '0', '326217600', '772.400', '30', '0', '6', '0', '中国银行', '1551511515', '0', 'UploadFiles/user_img/qrcode_2_20170728.jpg', 'leefon', '43', '85', '89', '河北省 秦皇岛市 北戴河区');
INSERT INTO `lr_user` VALUES ('3', 'LeeFon', 'LeeFon', '', '1504058479', '0', 'http://wx.qlogo.cn/mmhead/FFowRyeQrWia2HqZBUeR2ROdb1Wxb49QyTt2wAIDGEGI/132', null, '0', '1', '0', 'undefined', 'wx', '0', '0', '0', null, '0.100', '10', '0', '6', '0', null, null, '0', null, null, null, null, null, null);
INSERT INTO `lr_user` VALUES ('4', 'fghd', 'hddfg', '', '1504058555', '0', null, null, '0', '0', '0', '', '', '0', '0', '0', null, '0.150', '20', '0', '6', '0', null, null, '0', null, null, null, null, null, null);
INSERT INTO `lr_user` VALUES ('5', 'sfwerwe', 'werwr', '', '1504058556', '0', null, null, '0', '0', '0', '', '', '0', '0', '0', null, '0.200', '30', '0', '6', '0', null, null, '0', null, null, null, null, null, null);
INSERT INTO `lr_user` VALUES ('6', 'ryyu', 'tutft', '', '1504058557', '0', null, null, '0', '0', '0', '', '', '0', '0', '0', null, '0.100', '10', '0', '6', '0', null, null, '0', null, null, null, null, null, null);
INSERT INTO `lr_user` VALUES ('7', 'werf', 'gdfg', '', '1504058600', '0', null, null, '0', '0', '0', '', '', '0', '0', '0', null, '0.000', '20', '0', '6', '0', null, null, '0', null, null, null, null, null, null);

-- ----------------------------
-- Table structure for `lr_user_message`
-- ----------------------------
DROP TABLE IF EXISTS `lr_user_message`;
CREATE TABLE `lr_user_message` (
...
-- ----------------------------
-- Records of lr_user_message
-- ----------------------------
INSERT INTO `lr_user_message` VALUES ('1', '1', '1', '0', '1');
INSERT INTO `lr_user_message` VALUES ('2', '1', '3', '0', '0');
INSERT INTO `lr_user_message` VALUES ('3', '1', '4', '0', '0');
...
-- Records of lr_web
-- ----------------------------
INSERT INTO `lr_web` VALUES ('1', '0', '会员说明', '', '0', '', '1502163058');
INSERT INTO `lr_web` VALUES ('2', '0', '关于我们', '', '0', '', '1493257505');
